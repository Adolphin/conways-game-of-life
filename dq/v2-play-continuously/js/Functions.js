...
//Refresh the Table to be in accord with TableArray.
...
function Play(tableArray)
{
	var playHandle=setInterval(function(){generate(tableArray)},StepTime);
	return playHandle;
}
//Pause
function Pause(playHandle)
{
